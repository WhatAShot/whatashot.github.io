...
- Motivated by how neuron cells work and collaborate, the proposed new capsule structure is equipped with a transmitter and several optimizable receptors, and a capsule works like a neuron cell (i.e., transmitters compress and send capsule feautures to the higher level, and receptors of higher-level capsule semantically captures useful compressed features). The novel skeleton oragnizes the new capsules to execute agglomerative hierachical clustering for capsule features like a nervous system, without iteractive process.
</div>
</div>
