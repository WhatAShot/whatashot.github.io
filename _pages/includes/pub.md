...
- Motivated by how neuron cells work and collaborate, the proposed new capsule structure is equipped with a transmitter and several optimizable receptors, and a capsule works like a neuron cell (i.e., transmitters compress capsule feautures and send the compressed version to the higher level, and receptors of higher-level capsules semantically match the "right parts"). The novel skeleton oragnizes the new capsules to execute agglomerative hierachical clustering for capsule features like a nervous system, without iteractive process.
</div>
</div>
...
<div class='paper-box-text' markdown="1">
[DANETs: Deep Abstract Networks for Tabular Data Classification and Regression](https://ojs.aaai.org/index.php/AAAI/article/view/20309/20068)[<span style="color:SeaGreen">GLOM</span>, <span style="color:RoyalBlue">DLA-D</span>, <span style="color:#FC6A03;">DD (tabular learning)</span>], **Jintai Chen**, Kuanlun Liao, Yao Wan, Danny Z Chen, Jian Wu, **AAAI Conference on Artificial Intelligence (AAAI)**, 2022
