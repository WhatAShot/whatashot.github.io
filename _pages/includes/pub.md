...
- **Exposure**: Our work is promoted by more than 20 media and forums, such as [机器之心](https://mp.weixin.qq.com/s/nUOQjLzE7LPCizVAZJtA6Q), [专知](https://www.zhuanzhi.ai/document/2641de7df0eabfe36f40fd30fa33d848), [澎湃](https://www.thepaper.cn/newsDetail_forward_13432066), [AI研习社](https://www.yanxishe.com/reportDetail/27449).
 - **<span style="color:SeaGreen">On PHL</span>**: This work estimates projection functions to align part poses, and it is a simple case of PHL with an encoder-decoder to aggregate parts (ECG views).
...
- **<span style="color:SeaGreen">On PHL</span>**: Point cloud is a natural scenario that the object parts and wholes were naturally pose aligned, and we quantize the location information to capture part-whole relation using only **one** scalar feature in the proposed graph convolution and obtain the performance gain over 1% mAP.
</div>
<div markdown="1">
