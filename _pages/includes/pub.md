...
<div class='paper-box-text' markdown="1">
- **<span style="color:SeaGreen">On PHL</span>**: This work estimates projection functions w.r.t. viewpoints to align part poses, and it is a simple case of PHL with an encoder-decoder model.
