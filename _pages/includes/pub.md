...
- **<span style="color:SeaGreen">Insights for PHL</span>**: This work provides a new capsule neural network which presents a neural version of agglomerative hierarchical clustering to aggregate parts to represent wholes. Specially, we gave a constraint that the receptors of children capsules are recombined to act as receptors of parent capsules, thus capsules in different layers execute **one** agglomerative hierachical clustering.
