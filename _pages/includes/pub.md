...
- **<span style="color:SeaGreen">Insights of GLOM</span>**: This work provide a new GLOM method. Previous routing executes clustering by iteractive process, for flexibly aggregating parts into a whole. However, (i) cluster parts according to high-dimensional feature similarity suffers from "curse of dimension"; (ii) iterative process hinder to build a model deeper; (iii) feature value similarity cannot find semantically cooperative object parts. We separate a clustering process into severel steps as agglomerative hierachical clustering, and in each step capsules use its receptors (optimizable templates) to select helpful object parts. An important constraint we gave is that the receptors of children capsules are recombined to act as receptors of parent capsules, ensuring capsules in different layers to execute an agglomerative hierachical clustering, collectively.
</div>
<div markdown="1">
...
- Motivated by how neuron cells work and collaborate, the proposed new capsule structure is equipped with a transmitter and several optimizable receptors, and a capsule works like a neuron cell (i.e., transmitters compress a capsule feauture (an object part) and send the compressed feature to the higher level, and receptors of higher-level capsules semantically match the "right" object parts). The novel skeleton oragnizes all capsules jointly, like a nervous system, to execute an agglomerative hierachical clustering, without iteractive process.
</div>
</div>
...
<div class='paper-box-text' markdown="1">
[DANETs: Deep Abstract Networks for Tabular Data Classification and Regression](https://ojs.aaai.org/index.php/AAAI/article/view/20309/20068)[<span style="color:SeaGreen">GLOM</span>, <span style="color:RoyalBlue">DLA-D</span>, <span style="color:#FC6A03;">DD (tabular learning)</span>], **Jintai Chen**, Kuanlun Liao, Yao Wan, Danny Z Chen, Jian Wu, **AAAI**, 2022

- This work raises a principle "group & abstract" for tabular learning, and explore the impacts of model depth for tabular data processing.
