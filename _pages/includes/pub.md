...
- **<span style="color:SeaGreen">On PHL</span>**: This work estimates projection functions to align part poses, and it is a simple case of PHL with an encoder-decoder model to aggregate parts (ECG views).
